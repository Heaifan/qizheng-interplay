...
### 修复
- **FireOutput 曲线改为阶梯线**：从 polyline 折线改为 step path 阶梯线，匹配 rangeBand 分段系数模型，探针点与曲线不再视觉错位
- **工具栏按钮顺序调整**：播放/暂停按钮移至底部工具栏首位，回到开头按钮移至第二位，减少误触

### 优化
- 曲线采样点调整为分段边界（0/49/50/149/150/299/300/499/500/700/1000），阶梯转折点在边界处准确跳变
